...
{
  console.log(TAG + "Exception in HTML addSupplierSMS- getSMSBody - " + e);
  logger.error(TAG + "Exception in HTML addSupplierSMS- getSMSBody- :- error :" + e);
