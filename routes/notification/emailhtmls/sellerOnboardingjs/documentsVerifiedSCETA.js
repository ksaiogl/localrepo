...
try{
	...
	var emailSubject = "Congrats! You are now a supplier on mSupply.com";
	var emailBody = 
	...
	'									    <p style="color:#444;font-size:12px;line-height:20px;margin:0 0 10px 0;text-transform:uppercase;"><a style="color:#bd4931;text-decoration:none;font-weight:bold;" href="https://www.msupply.com/supplier">Click Here</a>, to login</p>'+
	'									</td>'+
	'								</tr>	'+							
	'							</tbody></table>'+
	'						</td>'+
	...
	'											<img width="720" alt="mSupply Benefit" src="http://static.msupply.com/emailTemplate/Howto_supplier_platform.jpg" style="text-align:center;">'+
	'										</td>'+
	'									</tr>'+
	'								</tbody>'+
	'							</table>'+
