...
var TAG = "registrationbody.js";

//Function to get the registration body.
exports.registrationemailbody = 
function registrationemailbody (firstName, mobile, password, callback){
       ...
       '</tr>'+
		'<tr>'+
		 '   <td>'+
			...
			'				   <p style="margin:10px 0;color:#444444;font-size:12px;line-height:20px;">Congratulations!  Your business has been <b>verified</b> and registration documents have been <b>approved</b>.</p>'+
			'				   <p align="center" style="margin:14px 0 0;color:#444444;font-size:15px;font-weight:700;">Now get more business with mSupply.com!</p>'+
			'			   </td>'+
			'		   </tr>'+
			'		   <tr>'+
			...
			'							    <h2 align="left" style="color:#1ca8a5;font-size:12px;">Your Login Details</h2>'+
			'								<table id="table1"; cellspacing="5px" cellpadding="5%"; align="left" style="color:#637078;font-size:12px;">'+
			'									<tr align="left">'+
			'										<td  align="left" style="padding:0;">Username: ' + mobile + '</td>'+
			'										<td class="style1"><input type="text" name="usernm" style="border:0;"/></td>'+
			'									</tr>'+
			'									<tr align="left">'+
			'										<td  align="left" style="padding:0;">Password: ' + password + '</td>'+
			...
			'						<tr width="722">'+
			'						    <td width="722" style="padding:20px 20px 0;">'+
			'							    <p style="color:#637078;font-size:15px;">Click <a href="https://play.google.com/apps/testing/mobileapp.msupply.com.affiliate" style="color:#bf4a32;">here</a>  to download the Android App</p><br/>'+
			'							</td>'+
			'						</tr>'+
