...
function getHtml (emailData, callback){
					    ...
					    '<tbody>'+
							...
							'<tr style="float:left;margin-right:30px;width:89%;margin-left:55px;">'+
							    '<td style="color:#545454;font-size:14px">'+
								    ...
								    '<p style="margin-top:10px;color:#444444;font-size:14px;font-weight:normal;line-height:20px;margin-bottom:10px;">Your quote for Enquiry ID has been received. The details of the same are mentioned in the email as below.</p>'+
							    '</td>'+
							'</tr>'+
	...
	'</table>';
		...
		console.log(TAG + "Exception in HTML quotationSubmitted- getHtml - " + e);
		logger.error(TAG + "Exception in HTML quotationSubmitted- getHtml- :- error :" + e);
