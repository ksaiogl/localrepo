var TAG = "sellerInquiryFloated.js";
...
function getHtml (emailData, callback){
	...
	try{	
		...
		var emailSubject = "New Enquiry Received │ Enquiry ID: "+inquiryId;
		...
		var remarks = emailData.inquiryDetails.inquiryEntity.remarks;
		//var customerName = emailData.inquiryDetails.inquiryEntity.customerName;
		var projectName = emailData.inquiryDetails.inquiryEntity.associatedProjectName;
					    ...
					    '<tbody>'+
							...
							'<tr style="float:left;margin-right:30px;width:89%;margin-left:55px;">'+
							    '<td style="color:#545454;font-size:14px">'+
								    ...
								    '<p style="margin-top:10px;color:#444444;font-size:14px;font-weight:normal;line-height:20px;margin-bottom:10px;"> You have received an enquiry. Please respond to this enquiry on or before '+inquiryDeactivationDate+'.</p>'+
							    '</td>'+
							'</tr>'+
								...
								'<td align="left">'+
									'<table width="86%" cellspacing="0" cellpadding="4" bordercolor="#aaa9a9" border="1" style="font-weight:normal;border-collapse:collapse;font-size:12px;color:#444;float:left;margin-left:56px;">'+
									    '<tbody>									   	'+
										   ...
										   '</tr>'+
										   	'<tr>'+
											  '<td style="padding:6px;width:25%;">Other Details</td>'+
											  '<td style="padding:6px;width:60%;">'+remarks+'</td>'+
										   '</tr>'+
									   '</tbody>'+
									'</table>'+
								'</td>'+
							...
							'<tr style="float:left;margin-right:30px;width:89%;margin-left:55px;">'+
							    '<td style="color:#545454;font-size:14px">'+
								    '<p style="margin-top:8px;color:#444444;font-size:13px;font-weight:normal;line-height:20px;margin-bottom:5px;">'+
									   '<a href="https://www.msupply.com/" style="color:#444444;text-decoration:none;font-weight:bold;">LOGIN</a> to mSupply Supplier Panel to manage it further.'+
									'</p>'+
							    '</td>'+
							'</tr>'+												
					    '</tbody>'+
	...
	'</table>';
		...
		console.log(TAG + "Exception in HTML sellerInquiryFloated- getHtml - " + e);
		logger.error(TAG + "Exception in HTML sellerInquiryFloated- getHtml- :- error :" + e);
