//notificationIdentifier: 107
var TAG = "lineItemsOrderCancellationEmail- ";
...
try
{
    ...
    emailBodyParams.grandTotal === null ))
	{
		...
		var emailSubject = "Line item cancelled for mSupply Order No: "+orderId;
	...
	{
	logger.error(TAG + "OrderFinance details received have null values - lineItemsOrderCancellationEmail- getHtml");
	return callback(true, "Null Validation Error");
	}	  
}
catch(e)
{
  console.log(TAG + "Exception in HTML lineItemsOrderCancellationEmail- getHtml - " + e);
  logger.error(TAG + "Exception in HTML lineItemsOrderCancellationEmail- getHtml- :- error :" + e);
