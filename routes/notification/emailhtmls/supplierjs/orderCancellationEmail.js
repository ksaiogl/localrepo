...
try
{
	...
	if(!(emailBodyParams.subTotal === null || emailBodyParams.vat === null ||
        emailBodyParams.shippingAndHandling === null || emailBodyParams.exciseDuty === null ||
        emailBodyParams.grandTotal === null ))
		{
			...
			var emailSubject = "mSupply order cancelled. Order No: "+orderId;
						...
						'<tbody>'+
							...
							'<tr style="margin-right:30px;margin-left:31px;float:left;width:87%;">'+
							  '<td style="color:#545454;font-size:14px">'+
								  ...
								  '<p style="color:#000;font-size:14px;line-height:30px;margin:0;">You have successfully cancelled the following order placed by the customer.</p>'+
							  '</td>'+
							'</tr>'+
							'<tr>'+
																				...
																				'<tbody>'+
																					'<tr style="border-bottom:1px solid #d5d5d5">'+
																						'<td width="170" valign="top" colspan="4" style="border-bottom:none;padding-left:5px;padding-top:20px;padding-bottom:20px;">'+
																							...
																							'<p style="color:#444;font-size:13px;">'+ customerFullName +' <br/>'+
																							addressLine1 +', <br/>'+ 
																							addressLine2+', <br/>'+ 
																							city + '-'+ pinCode +', <br/>'+ 
																							state+ '<br/>'+  
																							...
																							'<table width="100%" cellspacing="0" cellpadding="0" border="0" align="right">'+
																								'<tbody>'+
																									...
																									'<tr>'+
																									  ...
																									  '<td align="right" style="font-size:13px;color:#444444;padding:0 20px 12px;"><span><span>&#8377;</span>'+grandTotal+'</span></td>'+
																									'</tr>'+
																								'</tbody>'+
																							'</table>'+
																						'</td>'+
	...
	{
	logger.error(TAG + "OrderFinance details received have null values - OrderCancellationEmail- getHtml");
	return callback(true, "Null Validation Error");
	}	  
}
catch(e)
{
  console.log(TAG + "Exception in HTML OrderCancellationEmail- getHtml - " + e);
  logger.error(TAG + "Exception in HTML OrderCancellationEmail- getHtml- :- error :" + e);
