//notificationIdentifier: 306
var TAG = "OrderCancellationSupplierEmail- ";
...
try
{
        ...
        emailBodyParams.serviceCharges === null || emailBodyParams.grandTotal === null ))
  {
    ...
    var emailSubject = "Order No: "+orderId+" was cancelled";
      ...
      for(var i = 0; i < orderItems.length; i++)
      {
        ...
        '<tr>'+
           '<td width="30%" align="left" style="'+style+'">'+
             '<a href="https://www.msupply.com/" style="text-decoration:none;float:left;text-align:left" target="_blank">'+
            ...
            '<tbody>'+
              ...
              '<tr style="margin-right:30px;margin-left:31px;float:left;width:87%">'+
                '<td style="color:#545454;font-size:14px">'+
                  ...
                  '<p style="color:#000;font-size:12px;line-height:10px">We regret to inform you that mSupply <b> Order :'+orderId+' </b> has been cancelled by customer.</p>'+
                '</td>'+
              '</tr>'+
              '<tr>'+
  ...
  {
    logger.error(TAG + "OrderFinance details received have null values - OrderCancellationSupplierEmail- getHtml");
    return callback(true, "Null Validation Error");
  }  
}
catch(e)
{
  console.log(TAG + "Exception in HTML OrderCancellationSupplierEmail- getHtml - " + e);
  logger.error(TAG + "Exception in HTML OrderCancellationSupplierEmail- getHtml- :- error :" + e);
