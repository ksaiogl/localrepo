...
var TAG = "OrderPlacedWithChequeCustomerEmail- ";
...
try
{
  ...
  if(!(emailBodyParams.subTotal === null || emailBodyParams.discount === null ||
        ...
        emailBodyParams.serviceCharges === null || emailBodyParams.grandTotal === null ))
    {
      ...
      var emailSubject = "Order Placed - Your Order with mSupply.com [Order No: "+orderId+"] has been successfully placed!";
              ...
              '<tbody>'+
                ...
                '<tr style="margin-right:30px;margin-left:31px;float:left;width:87%">'+
                  '<td style="color:#545454;font-size:14px">'+
                    ...
                    '<p style="color:#000;font-size:12px;line-height:20px">Your Order is currently <b>"Under Processing"</b>. It will be confirmed once the payment is realised.</p>'+
                  '</td>'+
                '</tr>'+
                '<tr>'+
  ...
  {
    logger.error(TAG + "OrderFinance details received have null values - OrderPlacedWithChequeCustomerEmail- getHtml");
    return callback(true, "Null Validation Error");
  }    
}
catch(e)
{
  console.log(TAG + "Exception in HTML OrderPlacedWithChequeCustomerEmail- getHtml - " + e);
  logger.error(TAG + "Exception in HTML OrderPlacedWithChequeCustomerEmail- getHtml- :- error :" + e);
