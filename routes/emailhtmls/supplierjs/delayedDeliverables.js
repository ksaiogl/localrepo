var TAG = "delayedDeliverableEmail.js";
					...
					'<tbody>'+
						...
						'<tr style="margin-right:30px;margin-left:31px;float:left;width:92%;">'+
						  '<td style="color:#545454;font-size:14px">'+
							  '<p style="color:#000;font-size:14px;line-height:30px;margin:0;padding-top:10px;">Please note that the following line items in order no. '+ orderId +' have crossed its delivery date.</p>'+
							  '<p style="color:#000;font-size:14px;line-height:30px;margin:0;">Ensure the same gets supplied before it is too late.</p>'+
						  '</td>'+
						'</tr>'+
						'<tr>'+
