var TAG = "changePasswordSupplierEmail.js";
...
exports.changePasswordSupplierEmail = 
function changePasswordSupplierEmail (firstName, callback){
				...
				'<tbody>'+
					...
					'<tr style="margin-right:30px;margin-left:31px;float:left;width:87%;">'+
					 ' <td style="color:#545454;font-size:14px">'+
						  ...
						  '<p style="color:#000;font-size:14px;line-height:30px;padding:10px 5px;margin:0 0 20px;">You have successfully updated your password.</p>'+
					  '</td>'+
					'</tr>	'+												
					'<tr align="center">'+
