...
function registrationemailbody (callback){
				...
				'<tbody>'+
					'<tr style="margin-right:30px;margin-left:31px;float:left;width:87%;">'+
					    '<td style="color:#545454;font-size:14px" valign="top">'+
						    ...
						    '<p style="color:#000;font-size:14px;line-height:30px;margin:0;">Thank You for registering on mSupply.com!</p>'+
						    '<p style="color:#000;font-size:14px;line-height:30px;margin:0;">Kindly verify your mobile no. through the OTP and update your profile information.</p>'+
						    '<p style="color:#000;font-size:14px;line-height:30px;margin:0;">We will notify you once you are listed on the website.</p>'+
					    '</td>'+
					'</tr>'+			
				 '</tbody>'+
			   '</table>'+	
