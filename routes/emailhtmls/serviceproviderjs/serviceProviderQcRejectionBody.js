...
exports.getBody = 
function getBody(serviceProviderName, reasonForRejection, callback){
				...
				'<tbody>'+
					'<tr style="margin-right:30px;margin-left:31px;float:left;width:87%;">'+
					    '<td style="color:#545454;font-size:14px" valign="top">'+
						    '<p style="color:#000;font-size:14px;line-height:30px;margin:0;">Dear '+serviceProviderName+',</p><br/>'+
						    '<p style="color:#000;font-size:14px;line-height:30px;margin:0;">Your request to empanel with msupply.com as a service provider has been rejected. </p>'+
						    '<p style="color:#000;font-size:14px;line-height:30px;margin:0;">Reason for Rejection :'+reasonForRejection+' </p>'+
					    '</td>'+
					'</tr>'+		
				 '</tbody>'+
			   '</table>'+	
