				...
				'<tbody>'+
					'<tr style="margin-right:30px;margin-left:31px;float:left;width:87%;">'+
					    '<td style="color:#545454;font-size:14px" valign="top">'+
						    ...
						    '<p style="color:#000;font-size:14px;line-height:30px;margin:0;">Congratulations! Your profile is now listed on <a href="http://www.msupply.com/serviceprovider" style="color:red;">http://www.msupply.com/serviceprovider</a>.</p><br/>'+
						    '<p style="color:#000;font-size:14px;line-height:30px;margin:0;">You may opt to get a background verification done.</p>'+
						    '<p style="color:#000;font-size:14px;line-height:30px;margin:0;">Select “Get Verified” Option in the App Menu to get started.</p>'+
					    '</td>'+
					'</tr>'+		
				 '</tbody>'+
			   '</table>'+	
