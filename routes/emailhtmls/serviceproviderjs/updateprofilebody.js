       ...
       '</tr>'+
		'<tr>'+
		 '   <td>'+
			...
			'						         <span style="color:#444;font-size:14px;font-weight:normal;">For any further assistance you can reach us at <a href="mailto:'+htmlGenericvalues.support_email+'" style="color:#49bab6;text-decoration:none;font-weight:bold;">'+htmlGenericvalues.support_email+'</a></span><span style="color:#444;font-size:14px;font-weight:normal;"> or <b>'+htmlGenericvalues.support_contactnumber+'</b></span>'+
			'							 </td>'+
			'						</tr>'+
			'					</table>'+
			'				</td>'+
                  ...
                  ' </tr>'+
					...
					'		<p style="margin:0;float:left;width:100%;color:#637279;font-size:10px;">'+
                     '         <img alt="mail_icon" width="13" height="13" src="http://www.msupply.com/media/wysiwyg/registration_confirmation/mail_icon.png" style="margin-right:3px">'+							
						...
						'	   <span style="font-weight:normal;"><img alt="phone_icon" width="13" height="13" src="http://www.msupply.com/media/wysiwyg/registration_confirmation/phone_icon.png" style="margin-right:4px">'+htmlGenericvalues.support_contactnumber+'</span>'+
						'	</p>'+
						'</td>'+
					'</tr> '+
               '</table>'+
